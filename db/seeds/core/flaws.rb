...
module Flaws
  ...
  animal_companion = Flaw.create!(name: "Animal Companion",
    description: "You are accompanied by a loyal, intelligent (but mundane) animal that can obey simple com- mands. Your relationship with it is very close. If it should die, you would be profoundly upset.",
    flaw_type: "Story",
    book: "Core",
    major: false)
  ...
  blind = Flaw.create!(name: "Blind",
    description: "You have little or no sight. Using missile weapons is futile, reading is impossible, and nav- igation in unknown territory is difficult to say the least. Blind magi can detect targets by other senses, and thus are less limited than people try- ing to use missile weapons. However, blind magi cannot aim spells without magical aid.",
    flaw_type: "General",
    book: "Core",
    major: true)
  ...
  clumsy = Flaw.create!(name: "Clumsy",
    description: "You are not very graceful and tend to drop things — you are at –3 in all related rolls. Furthermore, roll an extra botch die when tak- ing actions related to Dexterity. Roleplay your clumsiness.",
    flaw_type: "General",
    book: "Core",
    major: false)

  clumsy_magic = Flaw.create!(name: "Clumsy Magic",
    description: "You have trouble aiming your spells accu- rately. Any aiming roll (see page 86) is subject to disastrous failure: an aiming roll of 0 is auto- matically a botch. (Aiming rolls do not count as mystical rolls for the purposes of gaining Warping Points.) You receive a –3 penalty to any rolls involving Finesse.",
    flaw_type: "Hermetic",
    book: "Core",
    major: false)

  compassionate_major = Flaw.create!(name: "Compassionate",
    description: "You help anyone who is wounded or in trou- ble. You cannot bear to see suffering in others, although you happily drive yourself to exhaustion.",
    flaw_type: "Personality",
    book: "Core",
    major: true)
  ...
  continence = Flaw.create!(name: "Continence",
    description: "You do not engage in sexual activity. This may be due to a vow of celibacy, or simply per- sonal choice.",
    flaw_type: "Personality",
    book: "Core",
    major: false)
  ...
  curse_of_venus = Flaw.create!(name: "Curse of Venus",
    description: "You are very attractive to people whom you do not wish to attract. People you detest keep getting crushes on you, and will not be dissuaded. Furthermore, you tend to fall in love with inappropriate people, and in inappropri- ate circumstances. Those people you are inter- ested in tend to think you are vain and shallow.",
    flaw_type: "Story",
    book: "Core",
    major: true)
  ...
  dark_secret = Flaw.create!(name: "Dark Secret",
    description: "You are haunted by something that would lead to shame, rejection, and possibly revenge if discovered. Hints about the secret continual- ly arise, and there might be others who know it and could betray you. This makes you avoid certain places, dislike certain people, or fear certain things.",
    flaw_type: "Story",
    book: "Core",
    major: true)

  deaf = Flaw.create!(name: "Deaf",
    description: "You cannot hear at all. You may be able to speak, but you cannot understand spoken lan- guage, which makes communication difficult. Magi with this flaw must roll an extra two botch dice when casting spells with a spoken compo- nent, as they cannot hear what they are saying.",
    flaw_type: "General",
    book: "Core",
    major: true)
  ...
  dependent = Flaw.create!(name: "Dependent",
    description: "You feel responsible for someone, and bound to help if he is in trouble. This person may be a rel- ative or friend, but should be relatively weak and a non-player character. If your Dependent passes beyond your ability to help, or becomes too pow- erful, you should substitute another Story Flaw. Possibilities include taking the children of the old Dependent as new Dependents, taking the killers of the Dependent as Enemies, or taking the Dependent as a True Friend.",
    flaw_type: "Story",
    book: "Core",
    major: true)

  depressed = Flaw.create!(name: "Depressed",
    description: "You have a dark outlook on life, seeing lit- tle point in acting and taking no pleasure in anything that happens.",
    flaw_type: "Personality",
    book: "Core",
    major: false)
  ...
  difficult_longevity_ritual = Flaw.create!(name: "Difficult Longevity Ritual",
    description: "Something in your magical nature makes it difficult to create an effective Longevity Ritual for you. Anyone (including yourself) cre- ating a Longevity Ritual for you must halve their Lab Total. You may create Longevity Rituals for others without penalty.",
    flaw_type: "Hermetic",
    book: "Core",
    major: true)

  difficult_spontaneous_magic = Flaw.create!(name: "Difficult Spontaneous Magic",
    description: "Spontaneous magic is always an effort for you. You cannot cast spontaneous spells without exerting yourself. However, when you do exert yourself, you cast spells as any other magus.
  ...
  difficult_underlings = Flaw.create!(name: "Difficlt Underlings",
    description: "You may only take this Story Hook if your character has, and will keep, underlings of some sort or another. No matter how many people you fire, or how carefully you vet new candidates, your underlings always cause prob- lems for you. The nature of the problems may change, but you are repeatedly drawn into dealing with the trouble they have caused. If other people give the same underlings orders, they have no problem. It’s not them, it’s you.",
    flaw_type: "Story",
    book: "Core",
    major: true)
  ...
  disorientating_magic = Flaw.create!(name: "Disorientating Magic",
    description: "After casting a spell, you must spend a round doing nothing but recovering your men- tal faculties.",
    flaw_type: "Hermetic",
    book: "Core",
    major: false)

  driven_major = Flaw.create!(name: "Driven",
    description: "You have some goal which you are deter- mined to bring about. This has to be the sort of big goal that could shape an entire life, but if you do accomplish it you will immediately turn to a new project.",
    flaw_type: "Personality",
    book: "Core",
    major: true)
  ...
  dutybound = Flaw.create!(name: "Dutybound",
    description: "You adhere to a restrictive code of con- duct that forbids certain behavior, probably including prohibitions against lying, killing prisoners, stealing, and other occasionally use- ful actions. You follow this code out of guilt or fear rather than high-flown moral standards, and may spend more time justifying yourself than keeping your conduct pure.",
    flaw_type: "Personality",
    book: "Core",
    major: false)

  dwarf = Flaw.create!(name: "Dwarf",
    description: "You are the size of a child. Your comfort- able walking speed is two-thirds that of a nor- mal person. Your Size is –2, so the severity of wounds you take increases in three point incre- ments rather than five point increments (see page 171). You take a –1 penalty to each of Strength and Stamina, which may reduce each Characteristic as low as –6. You cannot take this Flaw and Giant Blood, Large, or Small Frame.",
    flaw_type: "General",
    book: "Core",
    major: true)
  ...
  envious_major = Flaw.create!(name: "Envious",
    description: "You believe that everyone has it better than you do, and that they don’t deserve their good fortune, while you do. Thus, you try to ruin their lives and take their goods for your- self. (This is not a good Flaw for a player char- acter, as it is likely to lead to conflict with the other players.)",
    flaw_type: "Personality",
    book: "Core",
    major: true)
  ...
  fury = Flaw.create!(name: "Fury",
    description: "A violent temper sometimes overwhelms you, sending you into a destructive, uncontrol- lable rage. You are likely to be provoked by some sort of specific event, such as being insulted, being hurt, or hearing the Order of Hermes disparaged. Roll 9+ on a stress die to avoid flying into a rage when such an event occurs, with another roll every round to try to calm yourself should you fail the first. On a botch, you try to kill everyone around you. While enraged you get +3 to Damage, but –1 on all other scores and rolls.",
    flaw_type: "Story",
    book: "Core",
    major: true)

  generous_major = Flaw.create!(name: "Generous",
    description: "You willingly give away your property to anyone who expresses a desire for it, even if they are not particularly deserving. If some- thing is very important, you might not give it to someone, but you will certainly share it.",
    flaw_type: "Personality",
    book: "Core",
    major: true)
  ...
  greater_malediction = Flaw.create!(name: "Greater Malediction",
    description: "You have been cursed by some supernat- ural power, in a way that greatly hinders you. The effects of the curse should be comparable to those of other Major Flaws. Indeed, almost any greater Flaw could be the result of a curse.",
    flaw_type: "Supernatural",
    book: "Core",
    major: true)
  ...
  hatred_major = Flaw.create!(name: "Hatred",
    description: "You hate someone or some group so much that hurting them dominates your life. The tar- get of your hatred must not be someone you could easily overcome.",
    flaw_type: "Personality",
    book: "Core",
    major: true)
  ...
  judged_unfairly = Flaw.create!(name: "Judged Unfairly",
    description: "Somehow you come across the wrong way to people, and they universally distrust and underestimate you. You catch no one’s eye, impress no one, and can get no one to take you seriously. If you ever find an exceptional some- one who sees you as you want to be seen, you will cling to that person.",
    flaw_type: "Personality",
    book: "Core",
    major: false)
  ...
  lesser_maledictions = Flaw.create!(name: "Lesser Maledictions",
    description: "You have been cursed by some supernat- ural power. The effects of the curse should be about as bad as other Minor General Flaws.",
    flaw_type: "Supernatural",
    book: "Core",
    major: false)
  ...
  lost_love = Flaw.create!(name: "Lost Love",
    description: "You have lost your true love to death, dis- tance, or marriage. You take little joy in life’s pleasures and give up easily in the face of diffi- culty, since you’ve already lost the most impor- tant struggle. On those occasions when you for- get yourself and have a good time, you inevitably feel sorrow afterwards, thinking about how it could have been if your love were with you.",
    flaw_type: "Personality",
    book: "Core",
    major: false)
  ...
  magical_air = Flaw.create!(name: "Magical Air",
    description: "People and animals react to you as if you had The Gift, but, at least as far as you know, you have no magical abilities. You may not take this Flaw if you actually do have The Gift; see The Blatant Gift (page 51) instead.",
    flaw_type: "General",
    book: "Core",
    major: true)
  ...
  meddler_major = Flaw.create!(name: "Meddler",
    description: "You want to fix other peoples’ lives: arrange matches, teach children to sew “prop- erly,” or tend the sick. You waste a lot of time and energy on such endeavors, and people usu- ally resent it.",
    flaw_type: "Personality",
    book: "Core",
    major: true)
  ...
  missing_hang = Flaw.create!(name: "Missing Hand",
    description: "Perhaps it was an accident or a punish- ment in your past that cost you one of your hands. Climbing, combat, and other activities normally requiring both hands are at a penalty of –3 or greater.",
    flaw_type: "General",
    book: "Core",
    major: false)
  ...
  noncombatant = Flaw.create!(name: "Noncombatant",
    description: "You have no interest in combat, nor do you have any ability with it. You might be unreason- ably afraid of combat, or a complete pacifist, or prone to freezing and doing nothing.",
    flaw_type: "Personality",
    book: "Core",
    major: false)
  ...
  optimistic_major = Flaw.create!(name: "Optimistic",
    description: "You are convinced that everything will turn out for the best. This is not overconfi- dence, as you accept that you might well fail. Even if you do, however, you are sure that cir- cumstances will mean that everything works to your benefit.",
    flaw_type: "Personality",
    book: "Core",
    major: true)
  ...
  oversensitive = Flaw.create!(name: "Oversensitive",
    description: "Something that others find merely unpleasant you consider intolerable. Examples might include an oversensitivity to disrespect, to slovenliness, or to impiety. If you are the vio- lent type, you may start fights with those who offend you.",
    flaw_type: "Personality",
    book: "Core",
    major: false)

  painful_magic = Flaw.create!(name: "Painful Magic",
    description: "Casting spells causes you to suffer the equivalent of one Fatigue level in pain for each spell you cast. This reduces all your actions by the appropriate Fatigue penalty, which is cumu- lative with any from actual fatigue or injuries (though you do not suffer any physical damage from pain). You recover these “pain levels” just like Fatigue levels.",
    flaw_type: "Hermetic",
    book: "Core",
    major: true)

  palsied_hands = Flaw.create!(name: "Palsied Hands",
    description: "Your hands shake uncontrollably, which makes casting spells or holding objects diffi- cult. All rolls involving holding or wielding an object are made at –2, including weapon skills. Magi and others who rely on hand gestures to work magic must roll an extra botch die when casting a spell.",
    flaw_type: "General",
    book: "Core",
    major: false)
  ...
  pious_major = Flaw.create!(name: "Pious",
    description: "You are a fervent follower of your reli- gion. You avoid the things it prohibits, and enthusiastically do the things it commands.",
    flaw_type: "Personality",
    book: "Core",
    major: true)
  ...
  poor_eyesight = Flaw.create!(name: "Poor Eyesight",
    description: "Bleary vision impedes your performance. Rolls involving sight, including rolls to attack and defend, are at –3. New environments are disorienting and perhaps frightening for you. This Flaw can be combined with Missing Eye (above), but the penalties are cumulative.",
    flaw_type: "General",
    book: "Core",
    major: false)

  poor_formulaic_magic = Flaw.create!(name: "Poor Formulaic Magic",
    description: "You are simply not very good at formula- ic magic. Subtract five from every roll that you make to cast formulaic spells. This does not apply to Ritual spells.",
    flaw_type: "Hermetic",
    book: "Core",
    major: false)

  poor_hearing = Flaw.create!(name: "Poor Hearing",
    description: "Subtract 3 from rolls involving hearing. Speech that is hard for others to understand because of language, dialect, or accent is almost impossible for you to follow. You often pretend to be listening to people when in fact you are not.",
    flaw_type: "General",
    book: "Core",
    major: false)

  poor_memory = Flaw.create!(name: "Poor Memory",
    description: "You have a very hard time recalling one type of thing, such as names, faces, or places.",
    flaw_type: "Personality",
    book: "Core",
    major: false)

  poor_student = Flaw.create!(name: "Poor Student",
    description: "You are bad at learning new things. Subtract three from all Advancement Totals derived from teaching and books (that is, you have no penalty to adventure experience, expo- sure, practice, or training), but do not reduce a total below one. If you could learn something without this Flaw, you still learn a bit.",
    flaw_type: "General",
    book: "Core",
    major: false)
  ...
  proud_major = Flaw.create!(name: "Proud",
    description: "You believe that you are more important than just about everybody, and expect the appropriate respect. Magi may admit one or two equals, but do not believe that they have any superiors. Mundanes will admit social superiors, but still believe themselves to be fun- damentally better than, say, the king.",
    flaw_type: "Personality",
    book: "Core",
    major: true)
  ...
  social_handicap = Flaw.create!(name: "Social Handicap",
    description: "You have some trait that keeps you from interacting easily with other people. This impairs your dealings with most of society, causing penalties of –3 on appropriate rolls. Examples include morose temperament, unworldliness, an unpleasant odor, or outspo- ken atheism.",
    flaw_type: "General",
    book: "Core",
    major: false)

  soft_hearted = Flaw.create!(name: "Soft-Hearted",
    description: "You cannot bear to witness suffering, and causing it brings you sleepless nights. Even the deaths of enemies are painful for you. You avoid danger and try to keep your friends out of it as well. Life and health mean so much that you would rather give up important goals than let another person risk combat. You are easily moved by song and story.",
    flaw_type: "Personality",
    book: "Core",
    major: false)

  study_requirement = Flaw.create!(name: "Study Requirement",
    description: "You are unable to study magic from books or vis alone. You must study in the presence of the appropriate Art. For example, you need to sit next to a brook or pond to study Aquam, or a large fire to study Ignem. Growing things are good for Creo, decaying ones good for Perdo. As your knowledge grows, you need to work with larger and larger quantities. See “Study Bonus Virtue” on page 49 for a list of examples.
  ...
  warped_magic = Flaw.create!(name: "Warped Magic",
    description: "Your magic is accompanied by some unpleasant side effect that always manifests itself the same way, but with increasing intensi- ty according to the level of the spell. Examples include nearby items become hot or nearby plant matter becomes shriveled and wilted. This effect may cause trouble from time to time, but is usually just annoying.",
    flaw_type: "Hermetic",
    book: "Core",
    major: false)
  ...
  weak_enchanter = Flaw.create!(name: "Weak Enchanter",
    description: "Your Gift is ill attuned to creating enchanted devices. Halve your Lab Total whenever you create or investigate an enchant- ed item. If you have a Deficiency that counts as part of the Lab Total, apply the Deficiency first and then halve the remaining total.",
    flaw_type: "Hermetic",
    book: "Core",
    major: false)

  weak_magic = Flaw.create!(name: "Weak Magic",
    description: "Your magic is particularly bad at penetrat- ing magic resistance. You halve the normal Penetration Total for all spells, and only get half the normal benefit when instilling Penetration into an item. Note that you halve the Penetration Total, after subtracting the spell level and making any adjustments for the use of Arcane Connections. You do not halve the Casting Total and calculate Penetration from that.",
    flaw_type: "Hermetic",
    book: "Core",
    major: false)

  weak_magic_resistance = Flaw.create!(name: "Weak Magic Resistance",
    description: "Any form of magic resistance you gener- ate is much weaker under relatively common circumstances which are fairly easy for an opponent to utilize, such as when you are wet or facing away from the caster of the spell. If the conditions are met, do not subtract the level of the effect from the casting total before calculating Penetration. You would be well advised to keep your weakness from being dis- covered by too many potential enemies.",
    flaw_type: "Hermetic",
    book: "Core",
    major: true)

  weak_parens = Flaw.create!(name: "Weak Parens",
    description: "Your parens was less powerful and a worse teacher than normal. You gain 60 fewer experi- ence points and 30 fewer spell levels from apprenticeship, for a total of 180 experience points and 90 levels of spells.",
    flaw_type: "Hermetic",
    book: "Core",
    major: false)

  weak_scholar = Flaw.create!(name: "Weak Scholar",
    description: "You don’t understand what others teach you very well. You get a –6 penalty to Lab Totals when working from the Lab Texts of others, including when re-inventing spells.",
    flaw_type: "Hermetic",
    book: "Core",
    major: false)

  weak_spontaneous_magic = Flaw.create!(name: "Weak Spontaneous Magic",
    description: "You may not exert yourself when casting spontaneous magic, so you always divide your Casting Total by five. In stressful conditions you must still roll a stress die to see if you botch, but the die roll does not add to your casting total. You may still use ceremonial casting.
  ...
  weakness = Flaw.create!(name: "Weakness",
    description: "You have a soft spot for some sort of object or person. In the face of this, all else is unimportant: promises are forgotten, duties neglected, and common sense cast to the winds. Examples include poets and storytellers, food, flattery, or a pretty face.",
    flaw_type: "Personality",
    book: "Core",
    major: false)

  weak_willed = Flaw.create!(name: "Weak-Willed",
    description: "You look to others for guidance rather than to yourself. Those who try to fool, intim- idate, or manipulate you gain +3 to their rolls. What you need more than anything else is to find someone you can trust.",
    flaw_type: "Personality",
    book: "Core",
    major: false)
